...
import type { HomeSeason } from "./homeSeason";
...
export type HomepageSeasonalContent = {
  ...
  categories: readonly GuideCategoryLink[];
};
...
export function guidePath(locale: PublicLocale, guide: GuideId) {
...
const homepageCategories = {
  en: [
    categoryLink("home", "Home"),
    categoryLink("books", "Books"),
    categoryLink("electronics", "Electronics"),
    categoryLink("general", "General"),
  ],
  zh: [
    categoryLink("home", "居家"),
    categoryLink("books", "書籍"),
    categoryLink("electronics", "電子產品"),
    categoryLink("general", "其他"),
  ],
  zhCn: [
    categoryLink("home", "家居"),
    categoryLink("books", "书籍"),
    categoryLink("electronics", "电子产品"),
    categoryLink("general", "其他"),
  ],
} satisfies Record<ClientLocale, readonly GuideCategoryLink[]>;
